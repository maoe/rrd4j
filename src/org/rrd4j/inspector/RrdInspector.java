...
public class RrdInspector extends JFrame {
    ...
    static final String ABOUT = "RRD4J project\nRrdInspector utility\n" +
            "Copyright (C) 2003-2008 Sasa Markovic. All rights reserved.";
     ...
     * <pre>
     * java -cp Rrd4jLite.jar org.rrd4j.inspector.RrdInspector
     * java -cp Rrd4jLite.jar org.rrd4j.inspector.RrdInspector [path to RRD file]
     * </pre>
     *
     * @param args
     */
